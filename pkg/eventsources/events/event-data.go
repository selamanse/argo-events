...
// SolaceEventData represents the event data generated by the Solace eventsource.
type SolaceEventData struct {
	// Topic refers to the Solace topic the message was received on
	Topic string `json:"topic"`
...
// MNSEventData represents the event data generated by AlibabaCloud MNS eventsource.
type MNSEventData struct {
	// A unique identifier for the message. A MessageId is considered unique across
	// all AlibabaCloud accounts for an extended period of time.
	MessageId string `json:"messageId"`
	// Each message attribute consists of a Name, Type, and Value. For more information,
	// see AlibabaCloud MNS Message Attributes
	// (https://help.aliyun.com/zh/mns/developer-reference/basic-concepts-queue?spm=a2c4g.11186623.0.0.49955b99DhT3lH)
	Body interface{} `json:"body"`
	// Metadata holds the user defined metadata which will passed along the event payload.
	Metadata map[string]string `json:"metadata,omitempty"`
}
